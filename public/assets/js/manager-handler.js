		...
		swal({
              ...
              if (willDelete) {
						...
						$.ajax({
							...
							var client_information = '<tr id="client_row' + data.Data_back.client_id + ' " ><td>'
							+ data.Data_back.company_name + '</td><td>' + data.Data_back.email + '</td><td>'
							+ data.Data_back.phone_number + '</td><td>' + data.Data_back.nationality + '</td><td>'
							+ data.Data_back.location + '</td></td>' ;

							client_information += '<td><button class="btn btn-primary client_edit_info" value="  ' + data.Data_back.client_id
							+ ' ">Edit</button></td><td> <button class="btn btn-danger client_delete_info" value=" '
							+ data.Data_back.client_id +'">Delete</button></td></tr>';
   ...
   swal({
              ...
              //$('#loading_progress').modal('show');
					...
					$.ajax({
						...
						var client_information = '<tr id="client_row' + data.datails.client_id + ' " ><td>'
						+ data.datails.company_name + '</td><td>' + data.datails.email + '</td><td>'
						+ data.datails.phone_number + '</td><td>' + data.datails.nationality + '</td><td>'
						+ data.datails.location + '</td></td>' ;

						client_information += '<td><button class="btn btn-primary client_edit_info" value="  ' + data.datails.client_id
						+ ' ">Edit</button> <button class="btn btn-danger client_delete_info" value=" '
						+ data.datails.client_id +'">Delete</button></td></tr>';

						$('#client_row' + data.datails.client_id).replaceWith(client_information);
