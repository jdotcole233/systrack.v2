        ...
        <div id="wrapper">
            ...
            <div class="topbar">
                ...
                <div class="topbar-left" style=".background-color: #f3f3f3;">
                    <a href="https://firmusadvisory.com/" class="logo"><span>FIRMUS-<span>SYSTRACK</span></span><i class="mdi mdi-layers"></i></a>
                </div>
                ...
                <div class="navbar navbar-default" role="navigation">
                    <div class="container">
                        ...
                        <a href="https://firmusadvisory.com/" class="logo" id="lo1"><span style="color: #36404e;">FIRMUS-<span>SYSTRACK</span></span><i class="mdi mdi-layers"></i></a>
                        ...
                        <ul class="nav navbar-nav navbar-right pull-left">
                            ...
                            <li>
                                <a href="https://firmusadvisory.com/" id="lo2"><h4 style="font-weight: 800;"><span style="color: #36404e;">FIRMUS-<span>SYSTRACK</span></span><i class="mdi mdi-layers"></i></h4></a>
                            </li>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="hidden-xs">
                                <a href="https://firmusadvisory.com/about-the-company/" target="_blank" class="menu-item">About Us</a>
                            </li>

                            <li class="hidden-xs">
                                <a href="https://firmusadvisory.com/contact-us/" target="_blank" class="menu-item">Contact</a>
                            </li>
                            <li class="hidden-xs">
