...
<head>
        ...
        <!-- App title -->
        <title>Firmus Advisory - Partner Finance</title>
        ...
        <link href="{{ asset('/plugins/ion-rangeslider/ion.rangeSlider.skinModern.css') }}" rel="stylesheet" type="text/css"/>
        ...
        <div id="wrapper">
            ...
            <div class="topbar">
                ...
                <div class="topbar-left" style="background-color: #f3f3f3;">
                    <a href="{{ url('/') }}" class="logo" id="lo1"><span style="color: #36404e;">FIRMUS-<span>SYSTRACK</span></span><i class="mdi mdi-layers"></i></a><!-- <a href="index-2.html" class="logo"><span>Zir<span>cos</span></span><i class="mdi mdi-layers"></i></a> -->
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown user-box">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right arrow-dropdown-menu arrow-menu-right user-list notify-list">
                                    ...
                                    <li id="profile_details" value="{{Auth::user()->emp_id}}"><a href="{{ url('/profile/partner-finance') }}"><i class="ti-user m-r-5"></i> Profile</a></li>
                                    @endif
                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul>
                            ...
                            <li class="has_sub">
                                <a href="{{ url('/finance/home/partner-finance') }}" class="waves-effect"><i class="mdi mdi-view-dashboard"></i><span id="countNotification" class="label label-success pull-right">0</span> <span> Home </span> </a>

                            </li>

                            <li>
                                <a href="{{ url('/finance/jobs/partner-finance') }}" class="waves-effect"><i class="fa fa-users"></i><span> Jobs &amp; Payments </span></a>
                            </li>
                           <li>
                                <a href="{{ url('/meeting/directory/partner-finance') }}" class="waves-effect"><i class="fa fa-users"></i><span> Meeting  </span></a>
                            </li>

                            <li>
                                <a href="{{ url('/address-book/partner-finance') }}" class="waves-effect"><i class="fa fa-book"></i><span> My Address Book </span></a>
                            </li>
                            ...
                            <!-- <li>
                                <a href="{{ url('/finance-reports') }}" class="waves-effect"><i class="mdi mdi-calendar"></i><span> Reports </span></a>
                            </li> -->
