                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown user-box">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right arrow-dropdown-menu arrow-menu-right user-list notify-list">
                                    ...
                                    <li id="profile_details" value="{{Auth::user()->emp_id}}" ><a  href="{{ url('/profile/admin') }}"><i class="ti-user m-r-5"></i> Profile</a></li>
                                    @endif
                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul>
                            ...
                            <li class="has_sub">
                                <a href="{{ url('/admin-home/admin') }}" class="waves-effect"><i class="mdi mdi-view-dashboard"></i><span id="countNotification" class="label label-success pull-right">5</span> <span> Home </span> </a>

                            </li>

                            <li>
                                <a href="{{ url('/admin-employees/admin') }}" class="waves-effect"><i class="fa fa-users"></i><span> Employees </span></a>
                            </li>
                            <li>
                                <a href="{{ url('/address-book/admin') }}" class="waves-effect"><i class="fa fa-book"></i><span> My Address Book </span></a>
                            </li>
