...
<head>
    ...
    <!-- App title -->
    <title>Firmus Advisory - Admin</title>
...
<body class="fixed-left">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li>
                            <a href="#" class="right-menu-item dropdown-toggle" data-toggle="dropdown">
                                ...
                                <span id="countNotificationbadge" class="badge up bg-success">4</span>
                            </a>
                                    ...
                                    @if(Auth::check())
                                        ...
                                        <ul
                                            ...
                                            <li id="profile_details" value="{{Auth::user()->emp_id}}"><a
                                                    href="{{ url('/profile/admin') }}"><i class="ti-user m-r-5"></i> Profile</a>
                                            </li>
                                    @endif
            ...
            <div class="sidebar-inner slimscrollleft">
                ...
                <div id="sidebar-menu">
                    ...
                    <ul>
                        ...
                        <li class="has_sub">
                            <a href="{{ url('/admin-home/admin') }}" class="waves-effect"><i
                                    class="mdi mdi-view-dashboard"></i><span id="countNotification"
                                    class="label label-success pull-right">5</span> <span> Home </span> </a>

                        </li>

                        <li>
                            <a href="{{ url('/admin-employees/admin') }}" class="waves-effect"><i
                                    class="fa fa-users"></i><span> Employees </span></a>
                        </li>
                        <li>
                            <a href="{{ url('/address-book/admin') }}" class="waves-effect"><i
 ...
 -->
                        <!-- <li>
                            <a href="{{ url('/meeting-directory/admin') }}" class="waves-effect"><i
                                    class="fa fa-line-chart"></i><span> Meetings </span></a>
                        </li> -->

                        <li>
                            <a href="{{ url('/firmus-web-stats/admin') }}" class="waves-effect"><i
                                    class="fa fa-line-chart"></i><span> Activity Log </span></a>
                        </li>

                        <li>
                            <a href="{{ url('/admin-jobs/admin') }}" class="waves-effect"><i
                                    class="fa fa-line-chart"></i><span> Jobs Template </span></a>
                        </li>
                        <li><a href="{{ route('logout') }}" onclick="event.preventDefault();
                                              //  alert('Hello');
                                                     document.getElementById('logout-form').submit();"><i
