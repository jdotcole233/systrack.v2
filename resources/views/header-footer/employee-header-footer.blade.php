...
<head>
    ...
    <!-- App title -->
    <title>Firmus Advisory - Employee</title>
    ...
    <link href="{{ asset('/plugins/ion-rangeslider/ion.rangeSlider.skinModern.css') }}" rel="stylesheet"
        type="text/css" />
    ...
    <div id="wrapper">
        ...
        <div class="topbar">
            ...
            <div class="topbar-left" style="background-color: #f3f3f3;">
                <a href="{{ url('/') }}" class="logo" id="lo1"><span
                        style="color: #36404e;">FIRMUS-<span>SYSTRACK</span></span><i class="mdi mdi-layers"></i></a>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown user-box">
                            <a href="#" class="dropdown-toggle waves-effect user-link" data-toggle="dropdown"
                                aria-expanded="true">
                                @if(Auth::check())
                                        <img src="{{ asset('/images/profile_photo/' . App\Models\Employee::where('emp_id', Auth::user()->emp_id)->value('profile_pic')) }}"
                                    ...
                                    <ul
                                        ...
                                        <li>
                                            <h5>Hi,
                                                {{DB::table('employees')->where('emp_id', Auth::user()->emp_id)->value('first_name')}}
                                            </h5>
                                        </li>
                                        <li id="profile_details" value="{{Auth::user()->emp_id}}"><a
                                                href="{{ url('/profile/employee') }}"><i class="ti-user m-r-5"></i> Profile</a>
                                        </li>
                                @endif
            ...
            <div class="sidebar-inner slimscrollleft">
                ...
                <div id="sidebar-menu">
                    ...
                    <ul>
                        ...
                        <li class="has_sub">
                            <a href="{{ url('/employee/home') }}" class="waves-effect"><i
                                    class="mdi mdi-view-dashboard"></i><span id="countNotification"
                                    class="label label-success pull-right">0</span> <span> Home </span> </a>

                        </li>
                        <li>
                            <a href="{{ url('/employee-jobs/employee') }}" class="waves-effect"><i
                                    class="mdi mdi-layers"></i><span> Job Requests </span></a>
                        </li>

                        <li>
                            <a href="{{ url('/employee/jobs/employee') }}" class="waves-effect"><i
                                    class="fa fa-users"></i><span> Assigned Jobs </span></a>
                        </li>
                        <li>
                            <a href="{{ url('/employee/clients/employee') }}" class="waves-effect"><i
                                    class="fa fa-users"></i><span> Clients </span></a>
                        </li>
                        <li>
                            <a href="{{ url('/address-book/employee') }}" class="waves-effect"><i
                                    class="fa fa-book"></i><span> My Address Book </span></a>
                        </li>
                        <!--
                            <li>
                                <a href="{{ url('/employee-reports') }}" class="waves-effect"><i class="mdi mdi-calendar"></i><span> Reports </span></a>
                            </li> -->

                        <!-- <li>
                            <a href="{{ url('/meeting/directory/employee') }}" class="waves-effect"><i
                                    class="fa fa-line-chart"></i><span> Meetings </span></a>
                        </li> -->
                        <li><a href="{{ route('logout') }}" onclick="event.preventDefault();
                                              //  alert('Hello');
                                                     document.getElementById('logout-form').submit();"><i
