        ...
        <div class="row" style="margin-bottom: 20px;">
            <div class="col-md-12">
                <button class="btn-rounded btn-inverse waves-effect waves-light m-b-5 pull-right" data-toggle="modal"
                    data-target="#con-close-modal"> <i class="fa fa-plus-circle m-r-5"></i> <span>Add Employee</span>
                </button>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="first_name" id="field-1"
                                            placeholder="Kassim" required>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="field-2" class="control-label">Other Name</label>
                                        <input type="text" class="form-control" name="other_name" id="field-2"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="last_name" id="field-3"
                                            placeholder="Balogun" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="contact_number" id="field-4"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="address" id="field-5"
                                            placeholder="Hse.25, East Legon" required>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="field-2" class="control-label">Company email</label>
                                        <input type="email" class="form-control" name="company_email" id="field-6"
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default waves-effect close_emp_form"
                            data-dismiss="modal">Close</button>
                        <button type="button" class="btn btn-info waves-effect waves-light save_changes">Save
                            changes</button>
                        <button type="button" class="btn btn-info waves-effect waves-light update_changes">update</button>
                        <button type="button" style="display: none;"
                            class="btn btn-warning waves-effect waves-light reset_password">Reset Password</button>
                    </div>
                    </form>
                </div>
            </div>
                                ...
                                @if(count($emp_information) > 0)
                                    @foreach($emp_information as $all_emp_info)
                                        <tr id="employee_row{{$all_emp_info->emp_id}}">
                                            <td>{{$all_emp_info->first_name}} {{" "}} {{$all_emp_info->other_name}}
                                                {{$all_emp_info->last_name}}</td>
                                            ...
                                            <td><a class="btn btn-danger employee_delete_info"
                                                    value="{{$all_emp_info->emp_id}}">Delete</a></td>
                                        </tr>
                                    @endforeach
                                @endif
                            </tbody>
