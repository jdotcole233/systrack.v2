    ...
    <div class="container">
        ...
        <div class="row" style="margin-bottom: 20px;">
            <div class="col-md-12">
                ...
                <div class="col-md-2">
                    <button class="btn-rounded btn-inverse waves-effect waves-light m-b-5 pull-right" data-toggle="modal"
                        data-target="#con-close-modal"> <i class="fa fa-plus-circle m-r-5"></i> <span>Add Client</span>
                    </button>
                </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="company_name" id="field-1"
                                                    placeholder="Company Name or Individual Name" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="email" class="form-control" name="email" id="field-2"
                                                    placeholder="abcd@firmusadvisory.com">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="phone_number" id="field-3"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="location" id="field-4"
                                                    placeholder="E.g East Legon" required>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="field-2" class="control-label">Address</label>
                                                <textarea type="text" class="form-control" name="address" id="field-5"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="nationality" id="country_check" class="form-control" required>
                                                    ...
                                                    <option value="Bolivia, Plurinational State of"
                                                        title="Bolivia, Plurinational State of">Bolivia, Plurinational State
                                                        of</option>
                                                    ...
                                                    <option value="Central African Republic"
                                                        title="Central African Republic">Central African Republic</option>
                                                    ...
                                                    <option value="Iran, Islamic Republic of"
                                                        title="Iran, Islamic Republic of">Iran, Islamic Republic of</option>
                                                    ...
                                                    <option value="Macedonia, the former Yugoslav Republic of"
                                                        title="Macedonia, the former Yugoslav Republic of">Macedonia, the
                                                    ...
                                                    <option value="Micronesia, Federated States of"
                                                        title="Micronesia, Federated States of">Micronesia, Federated States
                                                        of</option>
                                                    ...
                                                    <option value="Northern Mariana Islands"
                                                        title="Northern Mariana Islands">Northern Mariana Islands</option>
                                                    ...
                                                    <option value="Saint Pierre and Miquelon"
                                                        title="Saint Pierre and Miquelon">Saint Pierre and Miquelon</option>
                                                    ...
                                                    <option value="Sint Maarten (Dutch part)"
                                                        title="Sint Maarten (Dutch part)">Sint Maarten (Dutch part)</option>
                                                    ...
                                                    <option value="South Georgia and the South Sandwich Islands"
                                                        title="South Georgia and the South Sandwich Islands">South Georgia
                                                    ...
                                                    <option value="Taiwan, Province of China"
                                                        title="Taiwan, Province of China">Taiwan, Province of China</option>
                                                    ...
                                                    <option value="Turks and Caicos Islands"
                                                        title="Turks and Caicos Islands">Turks and Caicos Islands</option>
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-default waves-effect close_btn"
                                    data-dismiss="modal">Close</button>
                                <button type="button" id="add_client" class="btn btn-info waves-effect waves-light add">Save
                                    changes</button>
                                <button type="button" id="add_client"
                                    class="btn btn-info waves-effect waves-light update_client">Update</button>
                            </div>
                        </div>
                        </form>
                                ...
                                @foreach($new_client_information as $new_client)
                                    <tr>
                                        ...
                                        <td>{{$new_client->email}}</td>
                                         <td>
                                            <span class="badge {{ $new_client->status == 'ACTIVE' ? 'badge-success' : 'badge-danger' }} ">{{$new_client->status}}</span>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
                                ...
                                @foreach($client_info as $client)
                                    <tr id="client_row{{$client->client_id}}">
                                        ...
                                        <td><a class="btn btn-danger client_delete_info"
                                                value="{{$client->client_id}}">Delete</a></td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
