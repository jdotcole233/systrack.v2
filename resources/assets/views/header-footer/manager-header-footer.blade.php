...
<head>
        ...
        <!-- App title -->
        <title>Firmus Advisory - Manager</title>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown user-box">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right arrow-dropdown-menu arrow-menu-right user-list notify-list">
                                    ...
                                    <li id="profile_details" value="{{Auth::user()->emp_id}}"><a href="{{ url('/profile/manager') }}"><i class="ti-user m-r-5"></i> Profile</a></li>
                                    @endif
                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul>
                            ...
                            <li class="has_sub">
                                <a href="{{ url('/manager-home/manager') }}" class="waves-effect"><i class="mdi mdi-view-dashboard"></i><span id="countNotification" class="label label-success pull-right">0</span> <span> Home </span> </a>

                            </li>

                            <li>
                                <a href="{{ url('/manager-clients/manager') }}" class="waves-effect"><i class="fa fa-users"></i><span> Clients </span></a>
                            </li>

                            <li>
                                <a href="{{ url('/manager-jobs/manager') }}" class="waves-effect"><i class="mdi mdi-layers"></i><span> Jobs </span></a>
                            </li>

                            <li>
                                <a href="{{ url('/manager-my-jobs/manager') }}" class="waves-effect"><i class="mdi mdi-layers"></i><span> My Jobs </span></a>
                            </li>
                            ...
                            <li>
                                <a href="{{ url('/address-book/manager') }}" class="waves-effect"><i class="fa fa-book"></i><span> Address Book </span></a>
                            </li>
