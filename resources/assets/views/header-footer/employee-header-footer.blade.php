                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown user-box">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right arrow-dropdown-menu arrow-menu-right user-list notify-list">
                                    ...
                                    <li id="profile_details" value="{{Auth::user()->emp_id}}"><a href="{{ url('/profile/employee') }}"><i class="ti-user m-r-5"></i> Profile</a></li>
                                    @endif
                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="{{ url('/address-book/employee') }}" class="waves-effect"><i class="fa fa-book"></i><span> My Address Book </span></a>
                            </li>
<!--
                            <li>
                            ...
                            <li>
                                <a href="{{ url('/meeting/directory/employee') }}" class="waves-effect"><i class="fa fa-line-chart"></i><span> Meetings </span></a>
                            </li>
                            <li><a href="{{ route('logout') }}"
                                            onclick="event.preventDefault();
                                              //  alert('Hello');
