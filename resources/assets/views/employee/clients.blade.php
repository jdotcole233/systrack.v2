                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="button" id="add_client_employee" class="btn btn-info waves-effect waves-light add">Save changes</button>
                                                    <button type="button" id="add_client_employee" class="btn btn-info waves-effect waves-light update_client">Update</button>
                                                </div>
                                            </div>
                                       </form>
